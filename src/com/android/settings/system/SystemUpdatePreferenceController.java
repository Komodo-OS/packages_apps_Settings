...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    private static final String OTA_BUILD_TYPE_PROP = "org.komodo.build_type";
    private static final String OTA_APP_PACKAGE = "org.komodo.ota";
    ...
    public int getAvailabilityStatus() {
        String buildtype = SystemProperties.get(OTA_BUILD_TYPE_PROP,"beta");
        if (!mUm.isAdminUser() || !buildtype.equalsIgnoreCase("release")){
